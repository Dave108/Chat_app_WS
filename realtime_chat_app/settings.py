...
SECRET_KEY = 'django-insecure-4)&^l_806y6a!d!l2_pp(aoq-jgag-3f7&e$py6tzi27&j=wi8'
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            ...
            "hosts": [('redis://:pRtoG6cIFrJMu296gEdmhnvDEMl2FC2n@redis-11828.c258.us-east-1-4.ec2.cloud.redislabs.com:11828')]
        },
    },
}
# Database
